...
describe('LoanForm — render (HU-02)', () => {
  ...
  // ─── Render: select de plazo con opciones 7, 14, 21 ───────────
  test('renders loan days select with options 7, 14, 21', () => {
    render(<LoanForm />);
    const select = screen.getByLabelText(/Plazo del Préstamo/i);
...
describe('LoanForm — error and success display (HU-02)', () => {
  ...
  test('TC-HU02-01 — displays success alert with loan_id when created', () => {
    ...
    const successAlert = alerts.find(a => a.dataset.type === 'success');
