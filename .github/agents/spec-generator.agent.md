...
2. **Lee el contexto global:** `.github/AGENTS.md` y `.github/copilot-instructions.md`
3. **Lee stack y arquitectura:** `.github/instructions/backend.instructions.md` y `.github/instructions/frontend.instructions.md`
...
- Si el requerimiento es ambiguo o contradice el dominio vigente → listar preguntas antes de generar la spec.
- No arrastres nomenclatura legacy como `dept_reader` o supuestos de catalogo inexistente.
